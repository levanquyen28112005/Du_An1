...
public class SanPhamAdapter extends FirebaseRecyclerAdapter<SanPhamModel,SanPhamAdapter.myViewHolder> {
     ...
     * @param options
     */
    public SanPhamAdapter(@NonNull FirebaseRecyclerOptions<SanPhamModel> options) {
        super(options);
    }
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DialogPlus dialogPlus = DialogPlus.newDialog(holder.img.getContext())
                        .setContentHolder(new ViewHolder(R.layout.update_sp_admin))
...
//                        map.put("turl",turl.getText().toString());
                        ...
                        FirebaseDatabase.getInstance().getReference().child("SP")
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_view_sp, parent, false);
